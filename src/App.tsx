        ...
        <div className="max-w-md mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-red-200">Welcome, {user.name}!</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <div className="text-right mr-2">
              <div className="text-xs text-red-200">Rewards</div>
              <div className="text-sm">⭐ {user.loyaltyPoints} pts</div>
            </div>
            <button
              onClick={() => setCurrentView('cart')}
              className="relative p-2 hover:bg-red-800 rounded-lg transition-colors"
            >
          ...
          <div className="max-w-md mx-auto flex justify-around p-3">
            <button
              ...
              className={`flex flex-col items-center gap-1 p-2 rounded-lg transition-colors ${
                currentView === 'menu' ? 'text-red-700 bg-red-50' : 'text-gray-600'
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 p-2 rounded-lg transition-colors ${
                currentView === 'orders' ? 'text-red-700 bg-red-50' : 'text-gray-600'
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 p-2 rounded-lg transition-colors relative ${
                currentView === 'cart' ? 'text-red-700 bg-red-50' : 'text-gray-600'
              }`}
            >
              <ShoppingCart className="w-6 h-6" />
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 p-2 rounded-lg transition-colors ${
                currentView === 'profile' ? 'text-red-700 bg-red-50' : 'text-gray-600'
              }`}
            >
